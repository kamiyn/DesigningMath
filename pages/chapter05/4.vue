<template>
  <div>
    <p>Chapter 5 5-4 個々の〇の半径を時間に沿って動かす</p>
...
<script lang="ts">
/* http://localhost:3000/chapter05/4 */
...
export default defineComponent({
  ...
  methods: {
    ...
    loopFunc(
      ...
      const cycleSeconds = 2; // 2秒で1周したい
      const passedTime = new Date().getTime() - startTime;
      const objectKakudo = ((passedTime / 1000) * Math.PI * 2) / cycleSeconds;

      ctx.clearRect(0, 0, screenWidth, screenHeight); // 画面の消去
